...
| ~~**Linear**~~ ✅ | Cmd+K как точка входа во всё, keyboard nav (j/k), peek-панель, скорость UI | **Средняя** — W2a–W2d реализованы; осталось polish (peek companies/leads) |
...
| Monday Sales CRM | `improvements/monday-analysis-2026-07-12.md` |
