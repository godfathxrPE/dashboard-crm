...
import {
  ...
  Users, Building2, CalendarDays, BarChart3, Settings, Target, Sun, Rocket,
} from 'lucide-react';
...
const MAIN_NAV = [
  ...
  { href: '/deals',     label: 'Сделки',    jpLabel: '案件管理',       icon: FolderKanban,    badgeKey: null,               sectionColor: '#FF6633' },
  { href: '/projects',  label: 'Проекты',   jpLabel: '導入管理',       icon: Rocket,          badgeKey: null,               sectionColor: '#10B981' },
