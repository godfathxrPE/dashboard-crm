 ...
 *
 * S-DEAL-ZONES-1B: `withRing` — кольцо слева от списка. Проп нужен потому, что
 * эта карточка одна на два пути: зону «Риски» клиентской сделки и рельсу
 * внедрения/internal. Кольцо — только у зоны; на рельсе 320px оно съело бы
 * ширину списка, а у delivery здоровье считает своя формула (`getDeliveryHealth`).
 */
