...
const selectCls =
  'rounded-md border border-input bg-surface px-2 py-1.5 text-[12px] text-text-dim';
const inputCls =
  'min-w-0 flex-1 rounded-md border border-input bg-surface px-2 py-1.5 text-[12px] text-text-main placeholder:text-text-mute';
