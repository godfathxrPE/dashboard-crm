    ...
    <form onSubmit={submit} className="mt-3 space-y-2 border-t border-border pt-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <select
          ...
          className="min-w-[9rem] rounded border border-input bg-surface px-2 py-1.5 text-xs text-text-dim"
        >
        ...
        <select
          ...
          className="rounded border border-input bg-surface px-2 py-1.5 text-xs text-text-dim"
        >
        ...
        {type === 'field' ? (
          ...
          <>
            <input
              ...
              className="w-16 rounded border border-input bg-surface px-2 py-1.5 text-xs text-text-dim"
            ...
            <input
              ...
              className="min-w-0 flex-1 rounded border border-input bg-surface px-2 py-1.5 text-xs text-text-main placeholder:text-text-mute"
            />
          </>
        )}
      </div>
  ...
  return (
    <div className="rounded-xl border border-border bg-surface p-4">
      ...
      <select
        ...
        className="mb-3 w-full rounded border border-input bg-surface px-3 py-1.5 text-sm text-text-dim"
      >
        {pipelines.map((p) => (
