 ...
 *
 * ⚠️ Полнота — НЕ «здоровье сделки». Сигналы (`deal-signals.ts`) отвечают на
 * «что происходит», полнота — на «что не заполнено». Сливать нельзя: сигналов
 * «нет бюджета / нет контакта» там нет намеренно, их несёт бейдж полноты
