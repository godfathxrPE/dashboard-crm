 ...
 *
 * `stage_target_days` пишет редактор «Нормы стадий» (Настройки организации,
 * S-STAGE-NORMS-UI-3); на 24.09 заполнены обе воронки продаж. Фолбэк — порог
 * группы: он срабатывает у стадий без ключа (стадии внедрения, новые стадии).
 */
