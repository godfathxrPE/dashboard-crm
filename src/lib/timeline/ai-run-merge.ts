...
export type AiRunTimelineRow = {
  ...
  created_at: string;
  /**
   * S-AI-VIS-2: ленте статус не нужен (там всё событие — «прогон был»), а сводному
   * блоку компании нужен: незавершённый и упавший прогон он показывает наравне с
   * готовым. Поле в общей выборке, чтобы у блока не заводился свой запрос.
   */
  status: string;
};
