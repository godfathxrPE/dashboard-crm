  ...
  return useMutation({
    ...
    onMutate: async (input) => {
      ...
      const optimistic: Task = {
        ...
        reminded_at: null,
        // S-LEAD-CORE-1 (118): задача по лиду до конверсии. Той же природы, что поля
        // выше — Task=Row требует поле в литерале. Проставляется из карточки лида;
        // у задачи, созданной из общего борда, всегда null.
