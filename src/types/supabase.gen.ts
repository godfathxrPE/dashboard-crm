  ...
  public: {
    Tables: {
      ...
      pipeline_expected_roles: {
        ...
        Relationships: [
          {
            foreignKeyName: "pipeline_expected_roles_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pipeline_expected_roles_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pipeline_expected_roles_pipeline_id_fkey"
            columns: ["pipeline_id"]
            isOneToOne: false
