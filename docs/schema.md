...
> **Applied (в живой БД, ref `uoiavcabxgdjugzryrmj`):** миграции 001–038 (035–037 delivery P1/P2, 038 delivery P3 применена гейтом Cowork 2026-07-12). Фаза 1 multi-user
...
>
> **035** _(Delivery P1 «Проекты внедрения», файл написан 2026-07-10, НА ГЕЙТЕ —
> не применена)_ — **`projects.type` +`delivery`** (проект внедрения, спавнится из
...
**Delivery P1 (035, на гейте):** project-пайплайны (**ERP Внедрение**
...
### projects _(003, +Sprint 1, +015 nullable stage, +017, +019, +032 type/nullable, +035 delivery — на гейте)_ — «сделки/проекты»
...
### Delivery-P2b (037, НА ГЕЙТЕ — не применена) — команда + прогресс + apply-шаблон
...
- **037** _(Delivery P2b, файл написан 2026-07-11, **НА ГЕЙТЕ — не применена**)_ —
...
- **039** _(AUDIT A2.2, файл написан 2026-07-12, **НА ГЕЙТЕ — не применена**)_ —
