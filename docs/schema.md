...
> **114 (S-TL-3, ось 2 «Единая лента событий») — НАПИСАНА, НЕ ПРИМЕНЕНА**
...
### Лента сущности (112 applied `20260808204308` + 113 applied `20260808222500` + 114 **НАПИСАНА, НЕ ПРИМЕНЕНА**) — сборка на сервере, страницами, с фильтром по видам
