...
> edge не требует.
>
> **115 (S-TL-4, ось 2 «Единая лента событий») — НАПИСАНА, НЕ ПРИМЕНЕНА**
...
### Лента (112 `20260808204308` + 113 `20260808222500` + 114 applied `20260809083732` + 115 **НАПИСАНА, НЕ ПРИМЕНЕНА**) — сборка на сервере, страницами, с фильтром по видам, от сущности до организации
