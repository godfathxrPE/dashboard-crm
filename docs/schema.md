...
>
> **113 (S-TL-2, ось 2 «Единая лента событий») — НАПИСАНА, НЕ ПРИМЕНЕНА**
...
### Лента сущности (112 applied `20260808204308` + 113 **НАПИСАНА, НЕ ПРИМЕНЕНА**) — сборка на сервере, страницами
