...
> и `activity_log`, хотя четыре хука на них подписаны), закрыта миграцией **122** ниже.
>
> **122 (S-TAILS-1) — НАПИСАНА, НЕ ПРИМЕНЕНА** (`122_realtime_core_tables.sql`; номер
> сверен запросом к `schema_migrations` 2026-08-10 — последняя применённая
...
**Realtime (122 — НАПИСАНА, НЕ ПРИМЕНЕНА):** `companies` добавляется в publication
...
**Realtime (122 — НАПИСАНА, НЕ ПРИМЕНЕНА):** `contacts` добавляется в publication
...
**Realtime (122 — НАПИСАНА, НЕ ПРИМЕНЕНА):** `activity_log` добавляется в publication
