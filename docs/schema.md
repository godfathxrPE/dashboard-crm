...
>
> **123 (S-LEAD-CARRY-1) — НАПИСАНА, НЕ ПРИМЕНЕНА** (`123_lead_convert_carryover.sql`;
> номер сверен запросом к `schema_migrations` 2026-08-11 — последняя применённая
> `20260810121513 realtime_core_tables`). `applied` + версию проставит гейт после apply:
> спринт-PR их знать не может. Три вещи в одном файле, все — про то, что **конверсия
...
### companies _(002, +041 phones applied 2026-07-13, +102 юрреквизиты applied 2026-08-03, +103 okved applied 2026-08-03, **+123 chz_groups — НАПИСАНА, НЕ ПРИМЕНЕНА**)_
...
**`convert_lead` v3 (123, S-LEAD-CARRY-1 — НАПИСАНА, НЕ ПРИМЕНЕНА).** 119 переносила
