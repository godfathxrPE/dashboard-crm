...
>
> **110 (S-TG-3) — НАПИСАНА, НЕ ПРИМЕНЕНА** (`110_telegram_capture.sql`; номер сверен запросом к
...
**`telegram_capture_drafts`** _(110, S-TG-3 — **НЕ ПРИМЕНЕНА**)_ — черновик разбора между
