...
### С Delivery-P1 (035, НА ГЕЙТЕ — не применена) — проекты внедрения
...
- `seed_project_columns` (`trg_zz_seed_columns`, 032) сидит delivery дефолтной
  доской задач — в P1 не используется, P2 заменит фазовой (type-aware guard — P2).
...
- **035** _(Delivery P1, файл написан 2026-07-10, **НА ГЕЙТЕ — не применена**)_ —
