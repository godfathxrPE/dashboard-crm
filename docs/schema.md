...
>
> **120 (S-LEAD-HUB-2a) — НАПИСАНА, НЕ ПРИМЕНЕНА** (`120_lead_timeline.sql`; номер сверен
> запросом к `schema_migrations` 2026-08-10 — последняя применённая `20260810084635
> convert_lead_history`). Пятое значение `p_entity_type = 'lead'` у `entity_timeline`:
...
### Лента (112 `20260808204308` + 113 `20260808222500` + 114 applied `20260809083732` + 115 applied `20260809092051` + 120 **НАПИСАНА, НЕ ПРИМЕНЕНА**) — сборка на сервере, страницами, с фильтром по видам, от сущности до организации
...
- **`p_entity_type` — ПЯТЬ значений (120): `org | project | company | contact | lead`.**
  ⚠️ **`lead` (120, S-LEAD-HUB-2a) — НАПИСАНА, НЕ ПРИМЕНЕНА.** Работают три ветки из
