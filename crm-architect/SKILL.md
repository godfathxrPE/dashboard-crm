...
| **Cold review** | Спринт с миграцией, RLS, ролями, деньгами (КП/бюджеты) или удалением данных ⇒ первым пунктом «Твоих действий»: дифф + acceptance criteria в чистую сессию/другую модель, **без спринт-файла** | Гейт написал план; ошибку плана он не увидит (S-HEALTH-V2-1: «тест по спецификации не ловит дефект спецификации»). Grok делает это для плана — для кода не делал никто |
